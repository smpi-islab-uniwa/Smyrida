...
class Activitiestraces extends Component { 
    image ={
        image: null, 
        imageHash: Date.now()
    }
    ...
    StateImage = () => {
        ...
        fetch((window.globalConfig['serverURL'] || { siteName: process.env.REACT_APP_SERVER_URL})+'/activities_traces', {
                                                        method: 'POST',
                                                        body: data,
           ...
           render(){
               if (this.props.data.includes(".xes")){ 
                        ...
                        if(this.state.image===false){
                            ...
                            return(<div>  
                                <iframe className="borderless" title="activitiestracesxes" src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
               }
                    ...
                    if (this.state.isok===false){  
                        ...
                        if(this.image.image==null){
                            ...
                            const myhtml=`${this.image.image}?${this.image.imageHash}`;
                            return(<div>  
                                <iframe className="borderless"  title="activitiestracescsv"  src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
...
export default Activitiestraces;
