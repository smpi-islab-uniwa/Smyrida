...
class Activityfrequencyduration extends Component { 
    image ={
        image: null, 
        imageHash: Date.now()
    }
    ...
    StateImage = () => {
        ...
        fetch((window.globalConfig['serverURL'] || { siteName: process.env.REACT_APP_SERVER_URL})+'/activity_frequency_duration', {
                                                        method: 'POST',
                                                        body: data,
           ...
           render(){
               if (this.props.data.includes(".xes")){ 
                        ...
                        if(this.state.image===false){
                            ...
                            return(<div>  
                                <iframe className="borderless" title="activityfrequencyduration" src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
                    ...
                    if (this.state.isok===false){  
                        ...
                        if(this.image.image==null){
                            ...
                            const myhtml=`${this.image.image}?${this.image.imageHash}`;
                            return(<div>  
                                <iframe className="borderless" title="activityfrequencydurationcsv" src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
...
export default Activityfrequencyduration;
