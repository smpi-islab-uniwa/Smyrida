...
class Variants extends Component { 
    ...
    StateImage = () => {
        ...
        fetch((window.globalConfig['serverURL'] || { siteName: process.env.REACT_APP_SERVER_URL})+'/variants', {
                                                        method: 'POST',
                                                        body: data,
           ...
           render(){
               if (this.props.data.includes(".xes")){ 
                        ...
                        if(this.state.image===false){
                            ...
                            return(<div>  
                                <iframe className="borderless" title="variantsxes" src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
                    ...
                    if (this.state.isok===false){  
                        ...
                        if(this.image.image==null){
                            ...
                            const myhtml=`${this.image.image}?${this.image.imageHash}`;
                            return(<div>  
                                <iframe className="borderless" title="variantscsv" src={myhtml} width="1280" height="720"></iframe>
                            </div>)
                        }
