...
import Activityfrequencyduration from "./Activityfrequencyduration"
...
import Activitiestraces from "./Activitiestraces"
...
//import MultilevelMenu from "./MultilevelMenu" //MultilevelMenu geo change
      ...
      <div>
       ...
       <ul className="header">
              ...
              <div className="dropdown hideelemnt"><button className="dropbtn"> Visualizations </button>
                    ...
                    <ul>
                      <li>
                        <div className="dropdown hideelemnt"><button className="dropbtn"> Activities </button>
                            <a href="#/frequency">Activities Frequency</a>
                            <a href="#/meanduration">Activities Mean Duration</a>    
                            <a href="#/activityfrequencyduration">Activities Frequency & Mean Duration</a>    
                    ...
                    <ul>
                      <li>
                        <div className="dropdown hideelemnt"><button className="dropbtn"> Traces </button>
                    ...
                    <ul>
                      <li>
                        <div className="dropdown hideelemnt"><button className="dropbtn"> Other </button>
                            <a href="#/activities_traces">Activities of Traces</a>                                           
                        </div>
                      </li>
                    </ul> 
            ...
            <div className="content contentwidth">  
              ...
              <Route path="/activityfrequencyduration" component={() => <Activityfrequencyduration value={this.csvheaders}  folder={Cookies.get("session")}  data={this.state.specific} parentCallback = {this.callbackFunction}   />} />    
              ...
              <Route path="/activities_traces" component={() => <Activitiestraces value={this.csvheaders}  folder={Cookies.get("session")}  data={this.state.specific} parentCallback = {this.callbackFunction}   />} />    
